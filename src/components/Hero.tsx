...
const CORE_TECH_STACK: CoreTechItem[] = [
  {
    name: "Next.js 15",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#151926] border border-white/[0.08] hover:border-white/40 hover:shadow-[0_0_16px_rgba(255,255,255,0.22)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-white/15 to-transparent",
    textClasses: "text-gray-300 group-hover:text-white",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 180 180"
        fill="none"
      >
  ...
  },
  {
    name: "React 19",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0c1a24] border border-white/[0.08] hover:border-cyan-400/50 hover:shadow-[0_0_18px_rgba(6,182,212,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-cyan-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-cyan-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#61DAFB] shrink-0 group-hover:rotate-180 transition-transform duration-700 ease-in-out"
  ...
  },
  {
    name: "TypeScript",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0c182b] border border-white/[0.08] hover:border-blue-400/50 hover:shadow-[0_0_18px_rgba(49,120,198,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-blue-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-blue-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 rounded-sm group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 128 128"
      >
        <rect width="128" height="128" rx="16" fill="#3178C6" />
        <path
          d="M72.2 87.8c2.8 3.5 6.8 5.7 11.5 5.7 6.4 0 10.4-3.3 10.4-8.2 0-5.1-4.2-7.3-11.8-10.6-10.8-4.6-17.7-10.1-17.7-20.9 0-11.4 8.9-19.8 22.8-19.8 9 0 16 3.1 20.9 8.6l-6.8 7.7c-3.1-3.6-7.5-5.5-13.8-5.5-6.5 0-9.6 3.1-9.6 7.1 0 4.6 3.8 6.7 12 10.3 11.6 5 17.6 10.8 17.6 21.6 0 12.8-9.9 20.9-24.6 20.9-11.2 0-19.9-4.1-25.2-11.1l7.3-8.8zm-43.7 14.7V46.5H12v-9.5h43.1v9.5H38.5v56H28.5z"
          fill="#FFF"
        />
      </svg>
    ),
  },
  {
    name: "Node.js",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0f1d14] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(104,160,99,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-emerald-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-emerald-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 24 24"
      ...
      >
        ...
        <path
          d="M12 14.2c-2.3 0-3.8-1.2-3.8-2.9 0-2.5 2.5-2.9 4.4-3.2 1.5-.2 2.2-.5 2.2-1.2 0-.8-.7-1.3-1.7-1.3-1.3 0-2 .5-2.2 1.5L9 6.2c.5-1.8 2.1-2.7 4.7-2.7 2.3 0 4.1 1.1 4.1 3.1 0 2.3-2.2 2.8-4.1 3.1-1.6.2-2.5.5-2.5 1.3 0 .8.8 1.2 1.8 1.2 1.4 0 2.4-.6 2.7-1.7l2.4 1.1c-.7 1.7-2.3 2.6-4.1 2.6z"
          fill="#FFF"
        />
      </svg>
    ),
  },
  {
    name: "PostgreSQL",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0e172a] border border-white/[0.08] hover:border-indigo-400/50 hover:shadow-[0_0_18px_rgba(65,105,225,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-indigo-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-indigo-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 256 264"
      ...
      >
        <path
          d="M125.6 0C59.8 0 8.7 48.7 1.2 113.1c-2.3 20 2 37.6 12.8 52.8 9.7 13.6 24.3 22.4 41.5 24.9 3.2.5 6.4.7 9.5.7 1.5 0 3-.1 4.5-.2 0 1.2-.1 2.5-.1 3.7 0 37.9 30.7 68.6 68.6 68.6 15.6 0 30-5.2 41.6-14 11.2-8.5 19.3-20.7 22.9-34.7 17.5-3.5 31.8-14.7 39.5-30.8 7.3-15.3 7.8-32.9 1.3-49.8-3.7-9.5-9.6-17.9-17.3-24.8-1.5-1.3-3-2.6-4.6-3.7-.4-12.7-4.4-25-11.7-35.6C193.3 27 161.7 0 125.6 0z"
          fill="#336791"
        />
        <path
          d="M141.5 18.2c28.2 2.5 52.6 22.5 60.1 50.1 4.7 17.2 2.4 34.7-6.2 50.1-2.2 3.9-4.8 7.5-7.8 10.7-3.4 3.7-7.2 6.9-11.4 9.6-1.5 1-3 1.9-4.6 2.8-1.7.9-3.4 1.8-5.2 2.5-3.3 1.3-6.8 2.2-10.4 2.8-2 .3-4 .5-6 .5-1.3 0-2.6-.1-3.9-.2-2.1-.3-4.2-.8-6.1-1.6-4.7-1.8-8.8-4.8-11.8-8.7-2.6-3.4-4.2-7.5-4.6-11.8-.4-4.2.4-8.5 2.2-12.3 2.1-4.4 5.5-8 9.8-10.2 3.8-2 8.1-2.9 12.5-2.6 3.6.3 7.1 1.3 10.2 3 1.3.7 2.5 1.5 3.6 2.5 4.7-5.5 8.1-12 9.9-19 3.2-12.3 2.3-24.8-2.6-36.1-6.1-14.2-17.6-25-31.9-29.6-4.9-1.6-10.1-2.4-15.4-2.4-1.4 0-2.8.1-4.2.2z"
          fill="#FFF"
          opacity="0.9"
        />
      </svg>
  ...
  },
  {
    name: "MongoDB",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0c1c11] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(34,197,94,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-emerald-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-emerald-200",
    icon: (
      <svg
      ...
      >
        <path
          d="M12.001 0C11.666 0.17 10.518 1.493 9.98 2.345 6.993 6.953 5.485 11.238 6.012 15.688c0.643 5.372 4.417 8.106 5.989 8.312 1.572-0.206 5.346-2.94 5.989-8.312 0.527-4.45-0.981-8.735-3.968-13.343C13.484 1.493 12.336 0.17 12.001 0z"
          fill="#47A248"
        />
        <path
          d="M12.001 0.443v23.114c1.47-.215 4.885-2.736 5.48-7.702 0.493-4.156-.917-8.158-3.706-12.463C13.385 1.836 12.31 0.598 12.001 0.443z"
          fill="#499D4A"
        />
        <path
          d="M12.001 23.557c-1.47-.215-4.885-2.736-5.48-7.702-0.493-4.156 0.917-8.158 3.706-12.463 0.39-0.556 1.465-1.794 1.774-1.949v22.114z"
          fill="#3FA037"
        />
        <path
          d="M11.968 18.236c-.021-.013-.042-.027-.062-.041-1.393-.94-1.737-2.72-1.758-2.833-.213-1.127.17-2.146.591-2.871.378-.65 1.01-1.405 1.229-2.492.015 1.087.647 1.842 1.025 2.492.421.725.804 1.744.591 2.871-.021.113-.365 1.893-1.758 2.833-.02.014-.041.028-.062.041z"
          fill="#FFF"
          opacity="0.9"
        />
      </svg>
  ...
  },
  {
    name: "Tailwind",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#081b24] border border-white/[0.08] hover:border-cyan-400/50 hover:shadow-[0_0_18px_rgba(6,182,212,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-cyan-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-cyan-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 24 24"
      >
  ...
  },
  {
    name: "Docker",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0c1829] border border-white/[0.08] hover:border-blue-400/50 hover:shadow-[0_0_18px_rgba(36,150,237,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-blue-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-blue-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#2496ED] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 24 24"
      >
  ...
  },
  {
    name: "AWS",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#1f1608] border border-white/[0.08] hover:border-amber-400/50 hover:shadow-[0_0_18px_rgba(255,153,0,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-amber-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-amber-200",
    icon: (
      <svg
        className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF9900] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 24 24"
      >
  ...
  },
  {
    name: "Redis",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#200c0b] border border-white/[0.08] hover:border-red-400/50 hover:shadow-[0_0_18px_rgba(220,56,45,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-red-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-red-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#DC382D] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300"
        viewBox="0 0 24 24"
      >
  ...
  },
  {
    name: "REST APIs",
    badgeClasses:
      "bg-[#10131d]/90 hover:bg-[#0c1c14] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(16,185,129,0.35)] hover:-translate-y-0.5 hover:scale-[1.03]",
    shimmerClasses: "from-transparent via-emerald-400/20 to-transparent",
    textClasses: "text-gray-300 group-hover:text-emerald-200",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400 shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
  ...
  },
  {
    name: "Custom POS",
    badgeClasses:
      "bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/35 hover:border-orange-400 hover:shadow-[0_0_22px_rgba(255,138,0,0.45)] hover:-translate-y-0.5 hover:scale-[1.05]",
    shimmerClasses: "from-transparent via-orange-400/30 to-transparent",
    textClasses: "text-orange-300 group-hover:text-orange-200 font-bold",
    icon: (
      <svg
        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-orange-400 shrink-0 group-hover:scale-115 group-hover:-rotate-6 transition-transform duration-300"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
    ...
    extra: <span className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse ml-0.5" />,
  },
];
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center lg:items-start relative z-10">
        ...
        <div className="lg:col-span-7 min-w-0 w-full space-y-5 sm:space-y-6">
          ...
          <div className="pt-1 sm:pt-2 space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-3">
            ...
            {/* CORE ticker: Continuous moving infinite marquee with hover-pause and edge fade masks */}
            <div className="w-full min-w-0 py-1 flex items-center gap-2 sm:gap-2.5">
              {/* Pinned CORE label */}
              <div className="flex items-center gap-1.5 text-[10px] font-mono font-bold tracking-wider text-orange-400 uppercase shrink-0 px-2 py-1 rounded-md bg-orange-500/10 border border-orange-500/25 shadow-[0_0_12px_rgba(249,115,22,0.15)] z-10 select-none">
                <span className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse" />
                <span>CORE</span>
              </div>

              {/* Auto-scrolling ticker track with subtle edge fading */}
              <div className="relative flex-1 min-w-0 overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_18px,black_calc(100%-18px),transparent)]">
                <div className="flex w-max items-center gap-2 sm:gap-2.5 animate-marquee hover:[animation-play-state:paused] py-1 cursor-pointer">
                  {[...CORE_TECH_STACK, ...CORE_TECH_STACK].map((tech, idx) => (
                    <div
                      key={`${tech.name}-${idx}`}
                      className={`group relative shrink-0 overflow-hidden flex items-center gap-1.5 px-2.5 py-1 rounded-lg ${tech.badgeClasses} active:scale-95 transition-all duration-300 shadow-sm`}
                    >
                      <div
                        className={`absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r ${tech.shimmerClasses} skew-x-12 pointer-events-none`}
                      />
                      {tech.icon}
                      <span className={`text-[11px] sm:text-xs font-semibold font-sans transition-colors ${tech.textClasses}`}>
                        {tech.name}
                      </span>
                      {tech.extra}
                    </div>
