      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center lg:items-start relative z-10">
        ...
        <div className="lg:col-span-7 min-w-0 w-full space-y-5 sm:space-y-6">
          ...
          <div className="pt-1 sm:pt-2 space-y-3 sm:space-y-0 sm:flex sm:items-center sm:gap-3">
            ...
            {/* CORE chips: wrap neatly on mobile and desktop with rich dynamic hover effects and brand glows */}
            <div className="w-full min-w-0 py-0.5">
              <div className="flex items-center gap-1.5 sm:gap-2 text-[11px] font-mono text-gray-400 flex-wrap">
                <div className="flex items-center gap-1 text-[10px] font-mono font-bold tracking-wider text-orange-400 uppercase shrink-0 mr-0.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse" />
                  <span>CORE:</span>
                </div>

                {/* Next.js 15 */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#151926] border border-white/[0.08] hover:border-white/40 hover:shadow-[0_0_16px_rgba(255,255,255,0.22)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-white/15 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 180 180" fill="none">
                  ...
                  <span className="text-gray-300 group-hover:text-white text-[11px] sm:text-xs font-semibold font-sans transition-colors">Next.js 15</span>
                </div>

                {/* React 19 */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0c1a24] border border-white/[0.08] hover:border-cyan-400/50 hover:shadow-[0_0_18px_rgba(6,182,212,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-cyan-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#61DAFB] shrink-0 group-hover:rotate-180 transition-transform duration-700 ease-in-out" viewBox="-11.5 -10.23174 23 20.46348" fill="currentColor">
                  ...
                  <span className="text-gray-300 group-hover:text-cyan-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">React 19</span>
                </div>

                {/* TypeScript */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0c182b] border border-white/[0.08] hover:border-blue-400/50 hover:shadow-[0_0_18px_rgba(49,120,198,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-blue-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 rounded-sm group-hover:scale-110 transition-transform duration-300" viewBox="0 0 128 128">
                  ...
                  <span className="text-gray-300 group-hover:text-blue-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">TypeScript</span>
                </div>

                {/* Node.js */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0f1d14] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(104,160,99,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-emerald-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none">
                  ...
                  <span className="text-gray-300 group-hover:text-emerald-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">Node.js</span>
                </div>

                {/* PostgreSQL */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0e172a] border border-white/[0.08] hover:border-indigo-400/50 hover:shadow-[0_0_18px_rgba(65,105,225,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-indigo-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 256 264" fill="none">
                  ...
                  <span className="text-gray-300 group-hover:text-indigo-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">PostgreSQL</span>
                </div>

                {/* MongoDB */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0c1c11] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(34,197,94,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-emerald-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24" fill="none">
                  ...
                  <span className="text-gray-300 group-hover:text-emerald-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">MongoDB</span>
                </div>

                {/* Tailwind CSS */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#081b24] border border-white/[0.08] hover:border-cyan-400/50 hover:shadow-[0_0_18px_rgba(6,182,212,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-cyan-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#06B6D4] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300 group-hover:text-cyan-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">Tailwind</span>
                </div>

                {/* Docker */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0c1829] border border-white/[0.08] hover:border-blue-400/50 hover:shadow-[0_0_18px_rgba(36,150,237,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-blue-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#2496ED] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300 group-hover:text-blue-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">Docker</span>
                </div>

                {/* AWS */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#1f1608] border border-white/[0.08] hover:border-amber-400/50 hover:shadow-[0_0_18px_rgba(255,153,0,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-amber-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FF9900] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300 group-hover:text-amber-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">AWS</span>
                </div>

                {/* Redis */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#200c0b] border border-white/[0.08] hover:border-red-400/50 hover:shadow-[0_0_18px_rgba(220,56,45,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-red-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#DC382D] fill-current shrink-0 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300 group-hover:text-red-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">Redis</span>
                </div>

                {/* REST APIs */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-[#10131d]/90 hover:bg-[#0c1c14] border border-white/[0.08] hover:border-emerald-400/50 hover:shadow-[0_0_18px_rgba(16,185,129,0.35)] hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-emerald-400/20 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400 shrink-0 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-gray-300 group-hover:text-emerald-200 text-[11px] sm:text-xs font-semibold font-sans transition-colors">REST APIs</span>
                </div>

                {/* Custom POS */}
                <div className="group relative overflow-hidden flex items-center gap-1.5 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-lg bg-orange-500/10 hover:bg-orange-500/20 border border-orange-500/35 hover:border-orange-400 hover:shadow-[0_0_22px_rgba(255,138,0,0.45)] hover:-translate-y-0.5 hover:scale-[1.05] active:scale-95 transition-all duration-300 cursor-pointer shadow-sm">
                  <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 ease-out bg-gradient-to-r from-transparent via-orange-400/30 to-transparent skew-x-12 pointer-events-none" />
                  <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-orange-400 shrink-0 group-hover:scale-115 group-hover:-rotate-6 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <span className="text-orange-300 group-hover:text-orange-200 text-[11px] sm:text-xs font-bold font-sans transition-colors">Custom POS</span>
