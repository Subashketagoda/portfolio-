...
export default function ProcessSection() {
  return (
    <section id="process" className="py-24 md:py-32 px-6 md:px-12 bg-[#080b0f] relative overflow-hidden">
      {/* Ambient background glows */}
      <div className="absolute top-1/2 left-1/3 w-[600px] h-[350px] bg-orange-500/[0.04] blur-[170px] pointer-events-none rounded-full" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="group relative rounded-2xl bg-[#0f1118] border border-white/[0.07] hover:border-orange-500/40 p-7 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-orange-500/10 overflow-hidden"
              >
